...
import com.gxj.graduation.entity.SimpleWebService;
...
public class BussinessFlowServiceImpl implements BussinessFlowService {
    ...
    @Override
    public void matchWebService(List<NodeData> nodeDataList) {
        //查询所有WS
        ...
        for (NodeData data: nodeDataList) {
            ...
            System.out.println(similarFunctions.toString());
        }
    }

    public List<WSFunctionDto> matchWSFunction(NodeData data, List<WebServiceDto> allWS ){
        //构建返回值列表
    ...
    private double calculateSimilarityFromParams(String[] strParams, List<WSParams> wsParams) {
